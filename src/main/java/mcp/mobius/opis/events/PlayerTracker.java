...
public enum PlayerTracker {
    ...
    public HashSet<EntityPlayerMP> playersSwing =
            new HashSet<EntityPlayerMP>(); // This is the list of players who have opened the UI
    ...
    public HashMap<String, Boolean> filteredAmount =
            new HashMap<String, Boolean>(); // Should the entity amount be filtered or not
    ...
    public AccessLevel getPlayerAccessLevel(String name) {
        ...
        if (MinecraftServer.getServer().getConfigurationManager().func_152596_g(profile)
                || MinecraftServer.getServer().isSinglePlayer()) return AccessLevel.ADMIN;
    ...
    public void addPrivilegedPlayer(String name, boolean save) {
        ...
        if (save) {
            modOpis.instance
                    .config
                    .get("ACCESS_RIGHTS", "privileged", new String[] {}, modOpis.commentPrivileged)
                    .set(playerPrivileged.toArray(new String[] {}));
    ...
    public void onPlayerLogout(PlayerEvent.PlayerLoggedOutEvent event) {
        ...
        PacketManager.sendPacketToAllSwing(new NetDataValue(
                ...
                new PlayerStatus(
                        ...
                        (int) event.player.posY,
                        (int) event.player.posZ)));
    }
