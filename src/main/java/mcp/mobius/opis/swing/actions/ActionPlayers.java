    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == panel.getBtnTeleport()) {
            ...
            PacketManager.sendToServer(
                    new PacketReqData(Message.COMMAND_TELEPORT_TO_ENTITY, new TargetEntity(eid, dim)));
        ...
        if (e.getSource() == panel.getBtnPull()) {
            ...
            int dim = data.pos.dim;
            PacketManager.sendToServer(
                    new PacketReqData(Message.COMMAND_TELEPORT_PULL_ENTITY, new TargetEntity(eid, dim)));
        }
    }
}
