...
public class PanelInbound extends JPanelMsgHandler implements ITabPanel {
    ...
    private static final long serialVersionUID = 8059336351920585340L;
    ...
    public PanelInbound() {
        ...
        table = new JTableStats(
                ...
                new Class[] { String.class, Integer.class, DataAmountRate.class, DataByteRate.class,
                        DataByteSize.class },
                new int[] { SwingConstants.LEFT, SwingConstants.CENTER, SwingConstants.RIGHT, SwingConstants.RIGHT,
