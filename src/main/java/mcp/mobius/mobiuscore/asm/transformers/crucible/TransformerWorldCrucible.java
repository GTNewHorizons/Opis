...
public class TransformerWorldCrucible extends TransformerBase {
    ...
    static {
        ...
        WORLD_PATTERN_LOADEDENTS = new AbstractInsnNode[] { Opcode.ALOAD(0),
                Opcode.NEW("io/github/crucible/util/HashedArrayList"), Opcode.DUP(),
                Opcode.INVOKESPECIAL("io/github/crucible/util/HashedArrayList", "<init>", "()V"),
                Opcode.PUTFIELD(
                        ObfTable.WORLD_LOADEDENTS.getClazz(),
                        ObfTable.WORLD_LOADEDENTS.getName(),
                        ObfTable.WORLD_LOADEDENTS.getDescriptor()) };

        WORLD_PATTERN_LOADEDTILES = new AbstractInsnNode[] { Opcode.ALOAD(0),
                Opcode.NEW("io/github/crucible/util/HashedArrayList"), Opcode.DUP(),
                Opcode.INVOKESPECIAL("io/github/crucible/util/HashedArrayList", "<init>", "()V"),
                Opcode.PUTFIELD(
