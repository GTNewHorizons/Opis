...
public enum ObfTable {
    ...
    WORLD_UPDATEENTITY(
            "ahb", "g", "(Lsa;)V", "net/minecraft/world/World", "updateEntity", "(Lnet/minecraft/entity/Entity;)V"),
    ...
    WORLD_PROVIDER(
            "mt", "t", "Laqo;", "net/minecraft/world/WorldServer", "provider", "Lnet/minecraft/world/WorldProvider;"),
    WORLDPROVIDER_DIMID("aqo", "i", "I", "net/minecraft/world/WorldProvider", "dimensionId", "I"),

    SERIALIZER_ENCODE(
            "fa",
            "a",
            "(Lio/netty/channel/ChannelHandlerContext;Lft;Lio/netty/buffer/ByteBuf;)V",
    ...
    PACKET_READPACKETDATA(
            ...
            "readPacketData",
            "(Lnet/minecraft/network/PacketBuffer;)V"),
    PACKET_GENERATEPACKET(
            "ft",
            "a",
            "(Lcom/google/common/collect/BiMap;I)Lpk;",
            "net/minecraft/network/Packet",
            "generatePacket",
            "(Lcom/google/common/collect/BiMap;I)Lnet/minecraft/network/Packet;"),
    ...
    RENDERMANAGER_RENDERPOSYAW(
            "bnn",
            "a",
            "(Lsa;DDDFF)Z",
            "net/minecraft/client/renderer/entity/RenderManager",
            "renderEntityWithPosYaw",
            "(Lnet/minecraft/entity/Entity;DDDFF)Z"),
    RENDERMANAGER_RENDER(
            "bnn",
            "a",
            "(Lsa;DDDFFZ)Z",
            "net/minecraft/client/renderer/entity/RenderManager",
    ...
    WORLD_INIT(
            "ahb",
            "<init>",
            "(Lazc;Ljava/lang/String;Lahj;Laqo;Lqi;)V",
    ...
    WORLD_LOADEDENTS(
            "ahb", "e", "Ljava/util/List;", "net/minecraft/world/World", "loadedEntityList", "Ljava/util/List;"),
    WORLD_LOADEDTILES(
            "ahb", "g", "Ljava/util/List;", "net/minecraft/world/World", "loadedTileEntityList", "Ljava/util/List;"),
/*
